...
output "data_owners" {
  description = "Identity group with Owner role on the BigQuery dataset."
  value       = var.owners_group_email
}

output "data_readers" {
  description = "Identity group with Reader role on the BigQuery dataset."
